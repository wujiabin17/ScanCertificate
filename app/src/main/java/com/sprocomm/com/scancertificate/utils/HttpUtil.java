package com.sprocomm.com.scancertificate.utils;
...
public class HttpUtil {
		...
		private static final String USERNAME="3daa6012-d572-40a4-99da-be81c2f5ffc6";//开发者平台API帐号
		private static final String PASSWORD="VSxlzOqIBzdkXBhTZMxTJzxRETjwAx";//开发者平台API密码
